...
SELECT ' 2','Ana Trujillo Emparedados y helados','Ana Trujillo','Avda. de la Constitución 2222','México D.F.','5021','Mexico' UNION ALL 
SELECT ' 3','Antonio Moreno Taquería','Antonio Moreno','Mataderos 2312','México D.F.','5023','Mexico' UNION ALL 
SELECT ' 4','Around the Horn','Thomas Hardy','120 Hanover Sq.','London','WA1 1DP','UK' UNION ALL 
SELECT ' 5','Berglunds snabbköp','Christina Berglund','Berguvsvägen 8','Luleå','S-958 22','Sweden' UNION ALL 
SELECT ' 6','Blauer See Delikatessen','Hanna Moos','Forsterstr. 57','Mannheim','68306','Germany' UNION ALL 
SELECT ' 7','Blondel père et fils','Frédérique Citeaux','24, place Kléber','Strasbourg','67000','France' UNION ALL 
SELECT ' 8','Bólido Comidas preparadas','Martín Sommer','C/ Araquil, 67','Madrid','28023','Spain' UNION ALL 
...
SELECT ' 13','Centro comercial Moctezuma','Francisco Chang','Sierras de Granada 9993','México D.F.','5022','Mexico' UNION ALL 
SELECT ' 14','Chop-suey Chinese','Yang Wang','Hauptstr. 29','Bern','3012','Switzerland' UNION ALL 
SELECT ' 15','Comércio Mineiro','Pedro Afonso','Av. dos Lusíadas, 23','São Paulo','05432-043','Brazil' UNION ALL 
...
SELECT ' 21','Familia Arquibaldo','Aria Cruz','Rua Orós, 92','São Paulo','05442-030','Brazil' UNION ALL 
SELECT ' 22','FISSA Fabrica Inter. Salchichas S.A.','Diego Roel','C/ Moralzarzal, 86','Madrid','28034','Spain' UNION ALL 
SELECT ' 23','Folies gourmandes','Martine Rancé','184, chaussée de Tournai','Lille','59000','France' UNION ALL 
SELECT ' 24','Folk och fä HB','Maria Larsson','Åkergatan 24','Bräcke','S-844 67','Sweden' UNION ALL 
SELECT ' 25','Frankenversand','Peter Franken','Berliner Platz 43','München','80805','Germany' UNION ALL 
...
SELECT ' 29','Galería del gastrónomo','Eduardo Saavedra','Rambla de Cataluña, 23','Barcelona','8022','Spain' UNION ALL 
SELECT ' 30','Godos Cocina Típica','José Pedro Freyre','C/ Romero, 33','Sevilla','41101','Spain' UNION ALL 
SELECT ' 31','Gourmet Lanchonetes','André Fonseca','Av. Brasil, 442','Campinas','04876-786','Brazil' UNION ALL 
SELECT ' 32','Great Lakes Food Market','Howard Snyder','2732 Baker Blvd.','Eugene','97403','USA' UNION ALL 
SELECT ' 33','GROSELLA-Restaurante','Manuel Pereira','5ª Ave. Los Palos Grandes','Caracas','1081','Venezuela' UNION ALL 
SELECT ' 34','Hanari Carnes','Mario Pontes','Rua do Paço, 67','Rio de Janeiro','05454-876','Brazil' UNION ALL 
SELECT ' 35','HILARIÓN-Abastos','Carlos Hernández','Carrera 22 con Ave. Carlos Soublette #8-35','San Cristóbal','5022','Venezuela' UNION ALL 
...
SELECT ' 39','Königlich Essen','Philip Cramer','Maubelstr. 90','Brandenburg','14776','Germany' UNION ALL 
...
SELECT ' 46','LILA-Supermercado','Carlos González','Carrera 52 con Ave. Bolívar #65-98 Llano Largo','Barquisimeto','3508','Venezuela' UNION ALL 
...
SELECT ' 51','Mère Paillarde','Jean Fresnière','43 rue St. Laurent','Montréal','H1J 1C3','Canada' UNION ALL 
...
SELECT ' 54','Océano Atlántico Ltda.','Yvonne Moncada','Ing. Gustavo Moncada 8585 Piso 20-A','Buenos Aires','1010','Argentina' UNION ALL 
SELECT ' 55','Old World Delicatessen','Rene Phillips','2743 Bering St.','Anchorage','99508','USA' UNION ALL 
SELECT ' 56','Ottilies Käseladen','Henriette Pfalzheim','Mehrheimerstr. 369','Köln','50739','Germany' UNION ALL 
SELECT ' 57','Paris spécialités','Marie Bertrand','265, boulevard Charonne','Paris','75012','France' UNION ALL 
SELECT ' 58','Pericles Comidas clásicas','Guillermo Fernández','Calle Dr. Jorge Cash 321','México D.F.','5033','Mexico' UNION ALL 
SELECT ' 59','Piccolo und mehr','Georg Pipps','Geislweg 14','Salzburg','5020','Austria' UNION ALL 
SELECT ' 60','Princesa Isabel Vinhoss','Isabel de Castro','Estrada da saúde n. 58','Lisboa','1756','Portugal' UNION ALL 
SELECT ' 61','Que Delícia','Bernardo Batista','Rua da Panificadora, 12','Rio de Janeiro','02389-673','Brazil' UNION ALL 
SELECT ' 62','Queen Cozinha','Lúcia Carvalho','Alameda dos Canàrios, 891','São Paulo','05487-020','Brazil' UNION ALL 
SELECT ' 63','QUICK-Stop','Horst Kloss','Taucherstraße 10','Cunewalde','1307','Germany' UNION ALL 
SELECT ' 64','Rancho grande','Sergio Gutiérrez','Av. del Libertador 900','Buenos Aires','1010','Argentina' UNION ALL 
...
SELECT ' 68','Richter Supermarkt','Michael Holz','Grenzacherweg 237','Genève','1203','Switzerland' UNION ALL 
SELECT ' 69','Romero y tomillo','Alejandra Camino','Gran Vía, 1','Madrid','28001','Spain' UNION ALL 
SELECT ' 70','Santé Gourmet','Jonas Bergulfsen','Erling Skakkes gate 78','Stavern','4110','Norway' UNION ALL 
...
SELECT ' 73','Simons bistro','Jytte Petersen','Vinbæltet 34','København','1734','Denmark' UNION ALL 
SELECT ' 74','Spécialités du monde','Dominique Perrier','25, rue Lauriston','Paris','75016','France' UNION ALL 
SELECT ' 75','Split Rail Beer & Ale','Art Braunschweiger','P.O. Box 555','Lander','82520','USA' UNION ALL 
SELECT ' 76','Suprêmes délices','Pascale Cartrain','Boulevard Tirou, 255','Charleroi','B-6000','Belgium' UNION ALL 
...
SELECT ' 79','Toms Spezialitäten','Karin Josephs','Luisenstr. 48','Münster','44087','Germany' UNION ALL 
SELECT ' 80','Tortuga Restaurante','Miguel Angel Paolino','Avda. Azteca 123','México D.F.','5033','Mexico' UNION ALL 
SELECT ' 81','Tradição Hipermercados','Anabela Domingues','Av. Inês de Castro, 414','São Paulo','05634-030','Brazil' UNION ALL 
SELECT ' 82','Trail"s Head Gourmet Provisioners','Helvetius Nagy','722 DaVinci Blvd.','Kirkland','98034','USA' UNION ALL 
SELECT ' 83','Vaffeljernet','Palle Ibsen','Smagsløget 45','Århus','8200','Denmark' UNION ALL 
...
SELECT ' 86','Die Wandernde Kuh','Rita Müller','Adenauerallee 900','Stuttgart','70563','Germany' UNION ALL 
...
--Products Insert data
 ...
 SELECT '22','Gustaf''s Knäckebröd','9','5','24 - 500 g pkgs.','21' UNION ALL 
 SELECT '23','Tunnbröd','9','5','12 - 250 g pkgs.','9' UNION ALL 
 SELECT '24','Guaraná Fantástica','10','1','12 - 355 ml cans','4.5' UNION ALL 
 SELECT '25','NuNuCa Nuß-Nougat-Creme','11','3','20 - 450 g glasses','14' UNION ALL 
 SELECT '26','Gumbär Gummibärchen','11','3','100 - 250 g bags','31.23' UNION ALL 
 SELECT '27','Schoggi Schokolade','11','3','100 - 100 g pieces','43.9' UNION ALL 
 SELECT '28','Rössle Sauerkraut','12','7','25 - 825 g cans','45.6' UNION ALL 
 SELECT '29','Thüringer Rostbratwurst','12','6','50 bags x 30 sausgs.','123.79' UNION ALL 
 ...
 SELECT '38','Côte de Blaye','18','1','12 - 75 cl bottles','263.5' UNION ALL 
 ...
 SELECT '45','Røgede sild','21','8','1k pkg.','9.5' UNION ALL 
 ...
 SELECT '54','Tourtière','25','6','16 pies','7.45' UNION ALL 
 SELECT '55','Pâté chinois','25','6','24 boxes x 2 pies','24' UNION ALL 
 ...
 SELECT '61','Sirop d''érable','29','2','24 - 500 ml bottles','28.5' UNION ALL 
 SELECT '62','Tarte au sucre','29','3','48 pies','49.3' UNION ALL 
 SELECT '63','Vegie-spread','7','2','15 - 625 g jars','43.9' UNION ALL 
 SELECT '64','Wimmers gute Semmelknödel','12','5','20 bags x 4 pieces','33.25' UNION ALL 
 ...
 SELECT '71','Fløtemysost','15','4','10 - 500 g pkgs.','21.5' UNION ALL 
 SELECT '72','Mozzarella di Giovanni','14','4','24 - 200 g pkgs.','34.8' UNION ALL 
 SELECT '73','Röd Kaviar','17','8','24 - 150 g jars','15' UNION ALL 
 SELECT '74','Longlife Tofu','4','7','5 kg pkg.','10' UNION ALL 
 SELECT '75','Rhönbräu Klosterbier','12','1','24 - 0.5 l bottles','7.75' UNION ALL 
 SELECT '76','Lakkalikööri','23','1','500 ml','18' UNION ALL 
 SELECT '77','Original Frankfurter grüne Soße','12','2','12 boxes','13'
...
--Suppliers Insert data
 ...
 SELECT '9','PB Knäckebröd AB','Lars Peterson','Kaloadagatan 13','Göteborg','S-345 67','Sweden','031-987 65 43' UNION ALL 
 SELECT '10','Refrescos Americanas LTDA','Carlos Diaz','Av. das Americanas 12.890','São Paulo','5442','Brazil','(11) 555 4640' UNION ALL 
 SELECT '11','Heli Süßwaren GmbH & Co. KG','Petra Winkler','Tiergartenstraße 5','Berlin','10785','Germany','(010) 9984510' UNION ALL 
 SELECT '12','Plutzer Lebensmittelgroßmärkte AG','Martin Bein','Bogenallee 51','Frankfurt','60439','Germany','(069) 992755' UNION ALL 
 ...
 SELECT '17','Svensk Sjöföda AB','Michael Björn','Brovallavägen 231','Stockholm','S-123 45','Sweden','08-123 45 67' UNION ALL 
 SELECT '18','Aux joyeux ecclésiastiques','Guylène Nodier','203, Rue des Francs-Bourgeois','Paris','75004','France','(1) 03.83.00.68' UNION ALL 
 ...
 SELECT '25','Ma Maison','Jean-Guy Lauzon','2960 Rue St. Laurent','Montréal','H1J 1C3','Canada','(514) 555-9022' UNION ALL 
 ...
 SELECT '28','Gai pâturage','Eliane Noz','Bat. B 3, rue des Alpes','Annecy','74000','France','38.76.98.06' UNION ALL 
 SELECT '29','Forêts d"érables','Chantal Goulet','148 rue Chasseur','Ste-Hyacinthe','J2S 7S8','Canada','(514) 555-2955'
